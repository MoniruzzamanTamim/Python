...
r = open("12) File_Handling\prac.txt","r")
r_data = r.read()
r.close()
print(r_data)
...
w = open("12) File_Handling\prac.txt","w")
...
a =  open("12) File_Handling\prac.txt","a")
...
rr = open("12) File_Handling\prac.txt","r+")
rr_data = rr.read()
...
ww = open("12) File_Handling\prac.txt","w+")
...
aa = open("12) File_Handling\prac.txt","w+")
...
with open("12) File_Handling\prac.txt", "r") as readfile:
