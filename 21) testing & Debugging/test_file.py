...
# # Custom decorators
# # -------------------
# strings_group = pytest.mark.strings
# number_group = pytest.mark.number
...
# @number_group
# def test_number():
#     number_from_function = number_test()
#     assert type(number_from_function) is int

# # @number_group
# def test_number_value():
#     number_from_function = number_test()
#     assert number_from_function == 123456
